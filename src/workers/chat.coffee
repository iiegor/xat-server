...
module.exports =
  ...
  joinRoom: (handler, roomId) ->
    ...
    database.query("SELECT * FROM chats WHERE id = '#{roomId}' ", (data)->
      @chat = data[0]

      handler.send "<i b=\"#{@chat.bg};=#{@chat.name};=22497272;=English;=http://87.230.56.15/;=#{@chat.button};=\" f=\"21233728\" v=\"1\" cb=\"2387\" />"
